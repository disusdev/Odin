...
// @ingroup world
EnqueueTaskCallback :: #type proc "c" (task: TaskCallback, taskContext: rawptr, userContext: rawptr, taskName: cstring) -> rawptr
...
// @ingroup debug_draw
CreateDebugShapeCallback  :: #type proc "c" (debugShape: ^DebugShape, userContext: rawptr) -> rawptr
DestroyDebugShapeCallback :: #type proc "c" (userShape: rawptr, userContext: rawptr)
...
// @warning Do not attempt to modify the world inside this callback
// @ingroup world
PreSolveFcn :: #type proc "c" (shapeIdA, shapeIdB: ShapeId, point: Pos, normal: Vec3, ctx: rawptr) -> bool
...
// @see b3World_CastRay
// @ingroup world
CastResultFcn :: #type proc "c" (shapeId: ShapeId, point: Pos, normal: Vec3, fraction: f32, userMaterialId: u64, triangleIndex: i32, childIndex: i32, ctx: rawptr) -> f32
...
Counters :: struct {
	...
	taskCount:        i32,
	colorCounts:      [24]i32,
	manifoldCounts:   [CONTACT_MANIFOLD_COUNT_BUCKETS]i32,
...
TreeQueryClosestCallbackFcn :: #type proc "c" (distanceSqrMin: f32, proxyId: i32, userData: u64, ctx: rawptr) -> f32
...
TreeBoxCastCallbackFcn :: #type proc "c" (input: ^BoxCastInput, proxyId: i32, userData: u64, ctx: rawptr) -> f32
...
TreeRayCastCallbackFcn :: #type proc "c" (input: ^RayCastInput, proxyId: i32, userData: u64, ctx: rawptr) -> f32
...
PlaneResultFcn :: #type proc "c" (shapeId: ShapeId, plane: ^PlaneResult, planeCount: i32, ctx: rawptr) -> bool

// Used to filter shapes for shape casting character movers.
// Return true to accept the collision
MoverFilterFcn :: #type proc "c" (shapeId: ShapeId, ctx: rawptr) -> bool
...
MeshEdgeFlags :: enum c.int {
	...
	allConcaveEdges = 0x07, // concaveEdge1 | concaveEdge2 | concaveEdge3

	flatEdge1 = 0x11, // concaveEdge1 | inverseConcaveEdge1
	flatEdge2 = 0x22, // concaveEdge2 | inverseConcaveEdge2
	flatEdge3 = 0x44, // concaveEdge3 | inverseConcaveEdge3

	allFlatEdges = 0x77, // flatEdge1 | flatEdge2 | flatEdge3
}
...
CompoundMesh :: struct {
	...
	materialIndices: [MAX_COMPOUND_MESH_MATERIALS]i32,
}
...
CompoundQueryFcn :: #type proc "c" (compound: ^CompoundData, childIndex: i32, ctx: rawptr) -> bool
...
LocalManifold :: struct {
	...
	points: [^]LocalManifoldPoint `fmt:"v,pointCount"`,
...
DebugShape :: struct {
	...
	using _: struct #raw_union {
		...
		compound:    ^CompoundData,    // Compound shape.
		heightField: ^HeightFieldData, // Height-field shape.
		hull:        ^HullData,        // Convex hull shape.
		mesh:        ^Mesh,            // Mesh shape with scale.
...
DebugDraw :: struct {
	...
	// Draw a line segment.
	DrawSegmentFcn: proc "c" (p1: Pos, p2: Pos, color: HexColor, ctx: rawptr),
	...
	// Draw a capsule.
	DrawCapsuleFcn: proc "c" (p1: Pos, p2: Pos, radius: f32, color: HexColor, alpha: f32, ctx: rawptr),
